							...
							<div class="d-none d-lg-flex align-items-center mr-3">
								...
								<button class="btn btn-icon aside-toggle ml-n3 mr-10" id="kt_aside_desktop_toggle">
									<span class="svg-icon svg-icon-xxl svg-icon-dark-75">
										<!--begin::Svg Icon | path:<?= base_url()?>assets/media/svg/icons/Text/Align-left.svg-->
								...
								<!--begin::Logo-->
								<a href="index.html">
									<img alt="Logo" src="<?= base_url()?>assets/media/logos/logo-letter-1.png" class="logo-sticky max-h-35px" />
								</a>
								<!--end::Logo-->
							...
							<div class="topbar">
								<!-- <div class="dropdown"> -->
									...
									<!-- <div class="topbar-item mr-4" data-toggle="dropdown" data-offset="10px,0px">
										<a href="<?=base_url('tahun_anggaran')?>" class="menu-link">
											<div class="btn font-weight-bolder btn-sm btn-light-success px-5">Dashboard</div>
										</a>
									</div>
								</div> -->

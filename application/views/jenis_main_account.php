	...
	<body id="kt_body" class="quick-panel-right demo-panel-right offcanvas-right header-fixed header-mobile-fixed subheader-enabled aside-enabled aside-static page-loading">
			...
			<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="exampleModalSizeLg">Form <Sub></Sub> Main Account</h5>
						<button type="button" class="close" data-dismiss="modal" aria-label="Close">
							<i aria-hidden="true" class="ki ki-close"></i>
						</button>
					</div>
					<form action="<?=base_url()?>jenis_main_account/addData" enctype="multipart/form-data" method="POST">
						<input type="text" id="tipe" name="tipe" hidden>
						<input type="text" id="id_jenis" name="id_jenis" hidden>
						<div class="modal-body">
							<div class="form-group">
								<label for="exampleInputPassword1">Main Account
								<span class="text-danger">*</span></label>
								<select class="form-control" id="id_main" name="id_main" required>
							...
							<div class="form-group">
								<label for="exampleInputPassword1">Sub Number
								<span class="text-danger">*</span></label>
								<input type="text" class="form-control" id="subnumber" name="id_subnumber" placeholder="subnumber" />
							</div>
							<div class="form-group">
								<label for="exampleInputPassword1">Nama Sub Main
								<span class="text-danger">*</span></label>
								<input type="text" class="form-control" id="nama_submain" name="nama_submain" placeholder="Nama Sub Main" />
							</div>
						</div>
		...
		<div class="modal fade" id="modaldeleteshow" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="exampleModalSizeLg" aria-hidden="true">
			<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="exampleModalSizeLg">Form Jenis Main Account</h5>
						<button type="button" class="close" data-dismiss="modal" aria-label="Close">
							<i aria-hidden="true" class="ki ki-close"></i>
						</button>
					</div>
					<div class="modal-body">
						<p>Apakah Anda Yakin Ingin Menghapus Data Sub Main Account ini?</p>
					<div class="modal-footer">
						<button  type="button" class="btn btn-light-primary font-weight-bold" data-dismiss="modal">Close</button>
	...
	<script type="text/javascript">
		"use strict";
			var table = $('#kt_datatable').DataTable({ 
				...
				"ajax": {
					"url": "<?php echo site_url('jenis_main_account/get_data_user')?>",
					"type": "POST"
				},
			...
			function edit_data(id_jenis) {
				...
				$.ajax({
					url: '<?php echo base_url() ?>jenis_main_account/ajax_edit/'+id_jenis,
					type: "POST",
					dataType: "JSON",
					cache: false,
					success: function(data){
						$('#id_jenis').val(data.id_submain);
						$('#nama_submain').val(data.nama_submain);
						$('#subnumber').val(data.id_subnumber);
			...
			$("#deletedata").click(function(){
				...
				$(location).attr('href', '<?php echo base_url('jenis_main_account/ajax_delete')?>/'+stat5+'')
